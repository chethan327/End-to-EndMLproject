...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            if not model_report:
                raise CustomException("Model evaluation failed: no models produced valid results.", sys)
            ...
            if best_model_score < 0.6:
                logging.warning(f"No model passed the threshold: Best score {best_model_score}")
            ...
            logging.info(f"Final R2 score: {score}")
            return score
